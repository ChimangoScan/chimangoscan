...
def fig_pull_vs_vuln():
    ...
    # (a) pull vs vulnerabilities, log-log
    m = (pull > 0) & (vuln > 0)
    ax[0].scatter(pull[m], vuln[m], s=3, color="#2166ac", alpha=0.12,
    ...
    ax[1].legend(h1 + h2, l1 + l2, loc="upper left", fontsize=6.6)
    fig.tight_layout(w_pad=2.4)
    save(fig, "fig_pull_vs_vuln")
