#!/usr/bin/env python3
"""
Figures: 3-way Venn of scanner agreement, official vs. community boxplot,
and a timeline of Docker Hub studies. Output in figures/.
"""
import json, os
import matplotlib
matplotlib.use("Agg")
...
# NOTE: the official vs. community panel (fig_panel_offcomm) is generated by
# square_figs.py (violin + bar); do not duplicate it here.

# ===== timeline of studies =====
# (prevalence of images with >=1 known vulnerability; metrics and
#  scanners differ between studies -- the metric/scanner of each point is
#  annotated in the label, see the caption. Numbers extracted from the papers in refs/.)
...
#   Wist 2021     : 81.8% certified with >=1 high/critical, 2.5k images   [wist]
