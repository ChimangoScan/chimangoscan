...
def main():
    ...
    ax[0].set_ylabel("Cumulative fraction of images")
    ...
    for l in ax[1].get_xticklabels():
        l.set_ha("right")
    # legenda horizontal acima do painel, fora da area de barras
    ax[1].legend(ncol=6, frameon=False, fontsize=5.8, loc="lower center",
                 bbox_to_anchor=(0.5, 1.04), columnspacing=0.7,
                 handlelength=1.0, handletextpad=0.4)
    ax[1].margins(y=0.12)
    ax[1].set_title("(b)", y=1.13)
    ...
    # ===== PAINEL 2: ecossistemas SBOM e tipos de secret =====
    # painel compacto (1x2): barras horizontais com grid e rotulos de valor
    fig, ax = plt.subplots(1, 2, figsize=(5.7, 2.05))
