...
# ==============================================================================
# ChimangoScan Research Pipeline Autopilot
...
echo "Total repositories discovered: $(docker exec -it chimangoscan_mongo mongosh localhost:27017/dockerhub_data --quiet --eval 'db.repositories_data.countDocuments()')"
echo "=============================================================================="
