...
Prerequisites on the host where it runs (<your-host>):
  - ranked jsonl: scanners/data/ditector_exposure_ranked.jsonl
    (output of scripts/compute_exposure_ranking.py)
  - queue.db: scanners/work/ditector.db
...
def main():
    ...
    ap.add_argument("--queue-db", required=True, help="path to scanners ditector.db")
