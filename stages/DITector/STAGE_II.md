...
This document describes in detail the architecture, internal workings, and supporting mechanisms of Phase II of ChimangoScan. Phase II consumes the repositories collected by Phase I in MongoDB, fetches tag and image metadata from Docker Hub, and inserts each image's layer chain into Neo4j as a dependency graph.
