# ChimangoScan — Large-Scale Docker Hub Security Research Pipeline
...
> [`scanners`](https://github.com/ChimangoScan/DITector) repository. The
> end-to-end orchestration of the two stages is handled by the
> [`chimangoscan`](https://github.com/ChimangoScan/DITector) repository.
...
log_file: "chimangoscan.log"   # path relative to the project root
...
go run main.go build \
  ...
  --tags 3 \
  --accounts accounts.json \
  --data_dir /tmp/chimangoscan_build \
  --config config.yaml
```
...
Stage III. The [`scanners`](https://github.com/ChimangoScan/DITector)
...
[`scanners`](https://github.com/ChimangoScan/DITector) repository.
